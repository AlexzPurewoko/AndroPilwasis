...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  if($auth_condition){
    ...
    $logout_sql = "UPDATE user_pilkasis SET has_running='0' WHERE username LIKE '$user_name' AND user_password LIKE '$passwd'";
    ...
    $result['message'] = "The users isn't registered";
